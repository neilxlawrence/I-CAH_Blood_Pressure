...
z values to assess dose in those aged 1 to 5
...
all_bootstrapped_estimates_model_l <- 
  list(NULL)

all_r2_systolic_model_l <-
  data.frame(NULL)

all_r2_diastolic_model_l <-
  data.frame(NULL)

all_predictions_complete_case_systolic_model_l <-
  list(NULL)

all_predictions_complete_case_diastolic_model_l <-
  list(NULL)

all_predictions_imputed_systolic_model_l <-
  list(NULL)

all_predictions_imputed_diastolic_model_l <-
  list(NULL)
...
formula_1_model_l_text <-
  paste0(systolic_outcome, 
         " ~ ", 
         independent_variables_model_l)

formula_2_model_l_text <-
...
formula_1_model_l <- 
  bf(formula_1_model_l_text)

formula_2_model_l <- 
  bf(formula_2_model_l_text)
...
#%%for (row_number in 1:10){
    for (row_number in 1:length(id_bootstrap_list_one_to_five[[this_bootstrap_number]])){
     #take out the patient
     id_to_pull <- 
       (id_bootstrap_list_one_to_five[[this_bootstrap_number]][row_number])
     ...
     #  print(paste0("Number of rows in this data_to_model_lrame:", nrow(data_to_model)))
  ...
  joint_model_l_this_bootstrap <- 
   brm(formula_1_model_l + formula_2_model_l + set_rescor(TRUE),
...
summary_of_joint_model_l_this_bootstrap <-
  summary(joint_model_l_this_bootstrap)
...
sink(paste0("loop_files/model_summaries/iterations_",
            ...
            this_bootstrap_number,
            ".txt"))
print(summary_of_joint_model_l_this_bootstrap)
sink()


#pull out the fixed effects estimates from the model from the summary
estimates_this_bootstrap <- 
  summary_of_joint_model_l_this_bootstrap$fixed[1]

#take out all of the random effects for centre
#systolic random effects
centre_systolic_intercept_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[1,1]
centre_systolic_intercept_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[1,5]
centre_systolic_slope_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[2,1]
centre_systolic_slope_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[2,5]
#diastolic random effects
centre_diastolic_intercept_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[3,1]
centre_diastolic_intercept_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[3,5]
centre_diastolic_slope_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[4,1]
centre_diastolic_slope_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[4,5]
#correlated random effects
centre_cor_effect_systolic_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[5,1]
centre_cor_effect_systolic_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[5,5]
centre_cor_effect_diastolic_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[6,1]
centre_cor_effect_diastolic_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$Centre.Name...Centre[6,5]
...
id_systolic_intercept_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[1,1]
id_systolic_intercept_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[1,5]
id_systolic_slope_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[2,1]
id_systolic_slope_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[2,5]
#diastolic random effects
id_diastolic_intercept_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[3,1]
id_diastolic_intercept_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[3,5]
id_diastolic_slope_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[4,1]
id_diastolic_slope_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[4,5]
#correlated random effects
id_cor_effect_systolic_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[5,1]
id_cor_effect_systolic_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[5,5]
id_cor_effect_diastolic_sd_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[6,1]
id_cor_effect_diastolic_rhat_this_bootstrap <-
  summary_of_joint_model_l_this_bootstrap$random$id[6,5]
...
r2_values_this_bootstrap <- 
  bayes_R2(joint_model_l_this_bootstrap)
...
all_r2_systolic_model_l <-
  rbind(all_r2_systolic_model_l,
        r2_values_this_bootstrap[1])
save(x=all_r2_systolic_model_l, 
             file = paste0("loop_files/all_r2_systolic_model_l", 
                           ".Rdata"), 
             compress=F)

all_r2_diastolic_model_l <-
  rbind(all_r2_diastolic_model_l,
        r2_values_this_bootstrap[2])
save(x=all_r2_diastolic_model_l, 
             file = paste0("loop_files/all_r2_diastolic_model_l", 
                           ".Rdata"), 
             compress=F)
...
all_bootstrapped_estimates_model_l[[length(
  all_bootstrapped_estimates_model_l) + 1]] <- 
  estimates_this_bootstrap
...
for (i in 2:length(all_bootstrapped_estimates_model_l)){  

  rownames(all_bootstrapped_estimates_model_l[[i]]) <- 
    gsub(x=rownames(all_bootstrapped_estimates_model_l[[i]]),
...
save(x=all_bootstrapped_estimates_model_l, 
             file = paste0("loop_files/all_bootstrapped_estimates_model_l", 
                           ".Rdata"), 
             compress=F)
...
imputed_bootstrapped_results_model_l <- 
  data.frame(NULL)
if (length(all_bootstrapped_estimates_model_l) > (number_of_imputations_to_run+1)){
for (i in (2+number_of_bootstraps):length(all_bootstrapped_estimates_model_l)){ 
  for (j in 1:length(rownames(all_bootstrapped_estimates_model_l[[2]]))){

  #take the number from each part of the list   
   this_row_name <- 
     (rownames(all_bootstrapped_estimates_model_l[[2]])[j])
  ...
  estimate_of_this_row <- 
    all_bootstrapped_estimates_model_l[[i]][this_row_name, "Estimate"]
...
#add that frame outstide of the loop  
  imputed_bootstrapped_results_model_l <-
    rbind(imputed_bootstrapped_results_model_l, 
          results_to_add)
...
imputed_bootstrapped_results_model_l_no_na <-
  na.omit(imputed_bootstrapped_results_model_l)
#then we can dplyr summarise that frame

bootstrapped_imputed_summary_results_model_l <-
  imputed_bootstrapped_results_model_l_no_na %>%
...
bootstrapped_imputed_summary_results_model_l$lower <-
  bootstrapped_imputed_summary_results_model_l$mean_estimate - 1.96 * bootstrapped_imputed_summary_results_model_l$sem_estimate
bootstrapped_imputed_summary_results_model_l$upper <-
  bootstrapped_imputed_summary_results_model_l$mean_estimate + 1.96 * bootstrapped_imputed_summary_results_model_l$sem_estimate

#then give myself a column that says '*' if significant
bootstrapped_imputed_summary_results_model_l$significant <-
  ifelse(bootstrapped_imputed_summary_results_model_l$lower < 0 &
           bootstrapped_imputed_summary_results_model_l$upper < 0 |
         bootstrapped_imputed_summary_results_model_l$lower > 0 &
           bootstrapped_imputed_summary_results_model_l$upper > 0,
         "*",
         "NS")
#then write those to csv outside of the loop
write.csv("loop_files/bootstrapped_imputed_summary_results_model_l.csv",
          x=bootstrapped_imputed_summary_results_model_l)
}
}
}
...
#start fresh here each time - the loop will rerun, but we are collecting all of the results from the whole list so we start a fresh
complete_case_bootstrapped_results_model_l <- 
  data.frame(NULL)
if (length(all_bootstrapped_estimates_model_l) > (number_of_bootstraps)){
...
#again we have to remove the imputation number from that 
  ...
  complete_case_bootstrapped_results_model_l <-
    rbind(complete_case_bootstrapped_results_model_l, 
          results_to_add)
  
  complete_case_bootstrapped_results_model_l_no_na <-
     na.omit(complete_case_bootstrapped_results_model_l)



bootstrapped_complete_case_summary_results_model_l <-
  complete_case_bootstrapped_results_model_l_no_na %>%
  group_by(model_parameter) %>%
  dplyr::summarise(
    mean_estimate = mean(estimate),
...
bootstrapped_complete_case_summary_results_model_l$lower <-
  bootstrapped_complete_case_summary_results_model_l$mean_estimate - 1.96 * bootstrapped_complete_case_summary_results_model_l$sem_estimate
bootstrapped_complete_case_summary_results_model_l$upper <-
  bootstrapped_complete_case_summary_results_model_l$mean_estimate + 1.96 * bootstrapped_complete_case_summary_results_model_l$sem_estimate


bootstrapped_complete_case_summary_results_model_l$significant <-
  ifelse(bootstrapped_complete_case_summary_results_model_l$lower < 0 &
           bootstrapped_complete_case_summary_results_model_l$upper < 0 |
         bootstrapped_complete_case_summary_results_model_l$lower > 0 &
           bootstrapped_complete_case_summary_results_model_l$upper > 0,
         "*",
         "NS")
write.csv("loop_files/bootstrapped_complete_case_summary_results_model_l.csv",
          x=bootstrapped_complete_case_summary_results_model_l)
  }
...
predictions_this_imputation <- 
  as.data.frame(predict(joint_model_l_this_bootstrap))
...
all_predictions_complete_case_systolic_model_l[[length(
  all_predictions_complete_case_systolic_model_l) + 1]] <- predictions_systolic_this_imputation
all_predictions_complete_case_diastolic_model_l[[length(
  all_predictions_complete_case_diastolic_model_l) + 1]] <- predictions_diastolic_this_imputation
save(x=all_predictions_complete_case_systolic_model_l, 
             file = paste0("loop_files/all_predictions_complete_case_systolic_model_l", 
                           ".Rdata"), 
             compress=F)
save(x=all_predictions_complete_case_diastolic_model_l, 
             file = paste0("loop_files/all_predictions_complete_case_diastolic_model_l", 
                           ".Rdata"), 
             compress=F)
}
...
if (imputation_number>0){
all_predictions_imputed_systolic_model_l[[length(
  all_predictions_imputed_systolic_model_l) + 1]] <- predictions_systolic_this_imputation
all_predictions_imputed_diastolic_model_l[[length(
  all_predictions_imputed_diastolic_model_l) + 1]] <- predictions_diastolic_this_imputation
save(x=all_predictions_imputed_systolic_model_l, 
             file = paste0("loop_files/all_predictions_imputed_systolic_model_l", 
                           ".Rdata"), 
             compress=F)
save(x=all_predictions_imputed_diastolic_model_l, 
             file = paste0("loop_files/all_predictions_imputed_diastolic_model_l", 
                           ".Rdata"), 
             compress=F)
}
...
rm(id_bootstrap_list_one_to_five)
```
